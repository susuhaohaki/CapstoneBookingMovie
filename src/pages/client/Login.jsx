...
const Login = () => {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-r from-blue-50 via-white to-blue-100 px-4 py-12">
      <NavLink to="/"
        className="absolute top-6 left-6 flex items-center cursor-pointer text-gray-600 hover:text-gray-800 transition duration-200" // Quay lại trang trước đó
      >
        <i className="fas fa-arrow-left text-lg mr-2"></i>
        <span className="text-sm font-medium">Back To Home</span>
      </NavLink>
      <div className="flex w-full max-w-4xl flex-col rounded-lg bg-white shadow-lg lg:flex-row">
        {/* Hình ảnh bên trái */}
        ...
        <div className="w-full px-6 py-8 lg:w-1/2">
          ...
          <form onSubmit={formik.handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="relative my-1">
                ...
                <i
                  ...
                  className={`fas fa-eye absolute right-3 top-1/2 -translate-y-1/2 transform cursor-pointer text-gray-400 ${
            ...
            <div>
              <button
                type="submit"
                className="w-full rounded-md bg-blue-500 px-4 py-3 text-white shadow-md transition duration-200 hover:bg-blue-600"
              >
                Đăng Nhập
              </button>
            </div>
