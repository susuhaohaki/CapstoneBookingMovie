    ...
    <>
      ...
      <div className="flex overflow-hidden bg-gray-900 pt-16">
        ...
        <div className="relative h-full w-full overflow-y-auto bg-gray-900 lg:ml-64">
          ...
          <footer className="mx-4 my-6 rounded-lg bg-gray-800 p-4 shadow md:flex md:items-center md:justify-between md:p-6 xl:p-8">
            <ul className="mb-6 flex flex-wrap items-center justify-evenly gap-1 md:mb-0">
              <li>
                <a
                  href="#"
                  className="text-sm font-normal text-gray-400 hover:underline md:mr-6"
                >
